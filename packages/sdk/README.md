...
`@nekon/sdk/application-event` and `@nekon/sdk/application-authorization`.
...
higher-level enrollment owner, which has not yet been extracted here. Never use
...
authorization and strict declaration checks. No production endpoint or registry
